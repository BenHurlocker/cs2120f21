...
and y is related to z, then x = z.

Example: Consider the friends relation on people
in Facebook. Is it reflexive? symmetric? transitive? symmetric

Example: Consider the "has a crush on" relation
on people. Is it reflexive? symmetric? Transitive? No

Example: Consider the less than relation on
natural numbers. Is it symmetric? Transitive? Transitive
